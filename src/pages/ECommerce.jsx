  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap justify-center'>
        ...
        h-44 rounded-2xl w-full max-w-4xl p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat
        bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              <p className='font-bold text-gray-400'>Оборот</p>
        ...
        <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
          {earningData.map(item => (
            <div
              ...
              w-56 flex-grow p-4 pt-9 rounded-2xl'
            >
              <button
                type='button'
                style={{
