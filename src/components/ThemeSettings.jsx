...
const ThemeSettings = () => {
  ...
  return (
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className='float-right h-screen bg-white w-400 dark:text-gray-200 dark:bg-secondary-dark-bg dark:[#484B52]'>
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'>
          <p className='font-semibold text-lg'>Цвет Темы</p>
